...
- Name: example.spec.ts >> Parabank Login Tests >> should display the login form
- Location: tests/example.spec.ts:10:7
...
Call log:
  ...
  - waiting for locator('#loginPanel')
